...
emails = df[cols[3]]
num = df[cols[2]]
send_to_email = 'krghost155@gmail.com'
subject = 'Indira silver jubilee excellence Awards 2019 invitation(QR code)'
message = 'You are cordially invited to Indira silver jubilee excellence Awards 2019 on 19th January (6:00 PM onwards) at Indira National School. We are sending you a unique QR code. Please download it and do not share this QR code as only one entry per QR code is permitted'
...
for _ in range(length):
    ...
    if os.path.isfile(filepath):
        ...
        server.sendmail(email,df[cols[3]].iloc[_], text)
        print("sent")
server.quit()
